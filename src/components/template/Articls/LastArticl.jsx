  ...
  return (
    <section className="sm:mt-[8rem] mt-[6rem]">
      <div className="w-fit container relative">
        ...
        {/* articl boxs */}
        <div className="w-fit grid grid-rows-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
          {articl.map((articl) => (
        ...
        <div class="hidden lg:block absolute right-0 top-0 translate-x-2/3 -translate-y-[60%] w-60 h-60 bg-amber-400 opacity-25 blur-[125px] -z-10 rounded-full"></div>
